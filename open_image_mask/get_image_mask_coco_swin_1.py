...
# Set directories
image_dir = "/weka/datasets/OpenImagesV6/validation"
output_dir = "/weka/datasets/OpenImagesV6/instance_segmentation_label/validation_swin_l"

# Create the output directory if it does not exist
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

gpu_id = 1  # Change this to the desired GPU (e.g., 1 for GPU 1)
...
def process_image(model, processor, image_path, output_dir):
    ...
    # Check if the mask file already exists, skip processing if it does
